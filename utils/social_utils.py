...
def calculate_loss(x, reconstructed_x, mean, log_var, criterion, future, interpolated_future, decouple=False):
	# reconstruction loss
...
# testing: 2829 / 11,200 traj (?70?:30)
# 8000 / 11,200 --------> 8000 -~ x2(flipping)-> 17,790 (training)
